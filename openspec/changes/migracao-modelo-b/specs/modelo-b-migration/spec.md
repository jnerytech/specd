...
- **WHEN** the deltas of `2026-07-fatia-2` and `2026-07-fatia-3` are read
...
- **GIVEN** REQ-FMT-005 and REQ-FMT-006 as written in `.specd/changes/2026-07-fatia-2/delta.md`
...
- **WHEN** `.specd/changes/2026-07-fatia-2/delta.md` is read
...
- **GIVEN** REQ-ANC-006 as modified in `.specd/changes/2026-07-fatia-2/delta.md`
...
- **GIVEN** REQ-ANC-008 as written in `.specd/changes/2026-07-fatia-2/delta.md`
...
- **GIVEN** REQ-ARC-002 and REQ-CLI-001 as written in `.specd/changes/2026-07-fatia-2/delta.md`
...
- **GIVEN** REQ-VER-005 as written in `.specd/changes/2026-07-fatia-2/delta.md`
...
- **GIVEN** REQ-VER-010 as written in `.specd/changes/2026-07-fatia-2/delta.md`
...
- **GIVEN** REQ-VER-011 as written in `.specd/changes/2026-07-fatia-2/delta.md`
...
- **GIVEN** REQ-CFG-007 as written in `.specd/changes/2026-07-fatia-2/delta.md`, and that under Modelo B a requirement's address changes over its lifetime while its identifier does not
...
- **GIVEN** REQ-CFG-008 and REQ-CFG-009 as written in `.specd/changes/2026-07-fatia-2/delta.md`, and that `2026-07-fatia-3` exists to hold REQ-VER-003 for an indefinite period
- **WHEN** `specd status` runs
...
- **GIVEN** that `AGENTS.md` previously named `.specd/changes/2026-07-fatia-1/` as the current scope and did not describe Modelo B
