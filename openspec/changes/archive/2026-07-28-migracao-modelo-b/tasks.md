...
Behaviour contract: REQ-IDs in `.specd/specs/` and in the deltas of `2026-07-28-archive-cycle-and-effective-specs` and `2026-07-28-provenance-and-mcp-transport`. Rationale per decision: `design.md` and `docs/design/2026-07-modelo-b-e-archive.md`.

## 1. change `archive-cycle-and-effective-specs` delta — migrated requirements

- [x] 1.1 Create `.specd/changes/2026-07-28-archive-cycle-and-effective-specs/delta.md` with frontmatter `change` and `target`
...
## 2. change `archive-cycle-and-effective-specs` delta — new requirements
...
- [x] 2.6 Write `.specd/changes/2026-07-28-archive-cycle-and-effective-specs/proposal.md` with scope, ordering and the self-application criterion

## 3. change `provenance-and-mcp-transport`

- [x] 3.1 Create `.specd/changes/2026-07-28-provenance-and-mcp-transport/delta.md` holding REQ-VER-003 with its text unchanged [REQ-VER-003]
- [x] 3.2 Write `.specd/changes/2026-07-28-provenance-and-mcp-transport/proposal.md` explaining why the change exists before being worked, and naming REQ-CFG-008 and REQ-CFG-009 as the guard against stalling
...
- [x] 5.4 Rewrite `test/dogfood.test.ts`, which asserted the gate was red — the change `verify-gate-and-anchor-ladder` criterion, now false — to assert the Modelo B invariant instead
...
- [x] 6.2 Replace the change `verify-gate-and-anchor-ladder` ordering and scope with change `archive-cycle-and-effective-specs`'s; mirror into `CLAUDE.md`
