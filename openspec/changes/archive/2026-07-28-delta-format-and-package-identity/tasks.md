# Tasks — delta-format-and-package-identity
...
- [x] 1.1 Delete the `## DEFERRED` section from `.specd/changes/2026-07-28-verify-gate-and-anchor-ladder/delta.md` [REQ-FMT-005]
- [x] 1.2 Move REQ-ANC-007, REQ-ANC-008, REQ-VER-004 and REQ-VER-005 into `.specd/changes/2026-07-28-verify-gate-and-anchor-ladder/proposal.md` as prose, stating why each was deferred
...
- [x] 2.2 Correct REQ-CLI-006's title in `.specd/changes/2026-07-28-verify-gate-and-anchor-ladder/delta.md` to "Zero-install distribution" [REQ-CLI-006]
...
- [x] 2.4 Record the unscoped-name reservation in `.specd/changes/2026-07-28-verify-gate-and-anchor-ladder/proposal.md` as an operational prerequisite, alongside the existing "Passo 0"
...
## 5. anchor-necessary-not-sufficient

- [x] 5.1 Add anchor-necessary-not-sufficient to `AGENTS.md`: an anchor is necessary, never sufficient — it answers where, not whether or when
- [x] 5.2 Mirror anchor-necessary-not-sufficient into `CLAUDE.md`, keeping the two files identical as they are today
- [x] 5.3 Record in anchor-necessary-not-sufficient the discipline change `verify-gate-and-anchor-ladder` followed: an anchor is never pointed at a partial implementation, and an honestly dangling anchor beats one resolved to a stub
