# Tasks — verify-gate-implementation

Behavior contract: REQ-IDs in `.specd/specs/`. Task details and acceptance: `.specd/changes/2026-07-28-verify-gate-and-anchor-ladder/tasks/`. Do not redefine behavior here.
...
- [x] 3.2 Task 008 — explore collectors [REQ-EXP-001..006] (`008-explore-collectors.md`)
...
- [x] 4.2 Dogfooding: `specd verify` runs on this repository and fails on real dangling anchors (change `verify-gate-and-anchor-ladder` success criterion)
