...
### Requirement: Fatia 1 artifacts conform to the rules Fatia 1 enforces

The corrections SHALL leave every artifact of `2026-07-fatia-1` and every requirement it touched consistent with `.specd/specs/`, verified by the acceptance criteria of the referenced requirements.
...
- **WHEN** `.specd/changes/2026-07-fatia-1/delta.md` is read
...
- **THEN** it asserts only what the package and its manifest can satisfy, and the registry reservation is stated in `.specd/changes/2026-07-fatia-1/proposal.md` as an operational prerequisite rather than an acceptance criterion
...
- **GIVEN** P1 (`AGENTS.md`), which keeps semantic judgement out of the decision path
