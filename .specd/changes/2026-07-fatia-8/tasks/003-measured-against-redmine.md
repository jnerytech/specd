...
`test/integration/redmine/orphans.test.ts` ganha os casos que faltam. Duplo concordaria com o que o adaptador acredita, que é justamente a crença sob teste — e foi assim que o 204 silencioso da Fatia 6 apareceu.
...
- Toda afirmação de que nada aconteceu é lida do servidor, não deduzida do relatório — P8 na direção da escrita
