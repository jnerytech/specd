...
Fechar o caminho que a Fatia 7 isentou: órfã declarada em `retired` cujo corpo reaparece em item planejado sem ligação deixa de fechar e passa a recusar, nomeando os dois identificadores.
...
- Órfã não declarada continua saindo 2 com o comportamento da Fatia 7 intacto
- O teste que a Fatia 7 escreveu para morte declarada continua passando sem edição
