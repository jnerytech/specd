...
- Nada de trabalho antes da checagem: `sync` e `explore` abrem rede e `archive` reescreve capabilities. Um `--help` avaliado depois da chamada seria a única forma desta change custar alguma coisa, e é costly-ops-are-not-silent
