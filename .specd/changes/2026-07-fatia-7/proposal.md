...
# Fatia 7 — fechar o laço, e parar de mentir na prosa

## Por quê

Duas coisas se juntaram e apontam para a mesma fatia.
...
achado do 204 da Fatia 6 — lá, escrita que reporta sucesso sem acontecer; aqui,
...
As duas têm a mesma causa de fundo, e é ela que a fatia ataca: **afirmação
verificável escrita em prosa, com nada verificando.** A Fatia 4 registrou o
...
momento em que é pago** — que virou P9, porque vale muito além de renomear.
...
P4 literal, e a saída é uma edição de uma linha que o autor faz vendo o que
...
## O que isto revelou, e que esta fatia não fecha
...
externa continua declarada — P9. Sem a flag, `archive` relata quantos itens
...
está fora do índice, ao alcance da revisão (P9). Desfazer destrói trabalho bom
...
exige.** P3 é a instância forte — o gate nunca acessa a rede, e há teste de
...
botão que existe sem dois clientes reais divergindo — P5. Se a resposta à
...
quatro do `sync`, duas do transporte MCP que faltam desde antes da Fatia 6. O
defeito é da mesma família que a lista de camadas resolvida na Fatia 4, e a
...
É a mesma forma do P8 uma casa acima: não é verde onde deveria ser vermelho, é
...
### 5. P9 escrito nos documentos de governo

Já aplicado a este repositório, porque governa como o resto da fatia é
...
P9 é princípio e não requisito pelo mesmo motivo de P7: decidir se uma operação
"custa alguma coisa" é julgamento, e P1 mantém julgamento fora do caminho de
...
primeiras estão em P8, e todas eram sobre o que a ferramenta lê:
...
`--dry-run`, que já existe desde a Fatia 6. A ligação viajando com o bloco, que
